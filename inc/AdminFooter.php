...
<script>
  function Surety() {
    if (confirm("Are you Sure!\nPress Ok if you want else Cancel") == true) {
      return true;
    } else {
      return false;
    }
...
<script src="dist/assets/js/page/modules-ion-icons.js"></script>
...
<script src="dist/assets/js/page/modules-slider.js"></script>
