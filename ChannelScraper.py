...
api_id = 23603005        # YOUR API_ID
api_hash = '5c5a4c3fb4ea563969421a7180c10bcb'        # YOUR API_HASH
phone = '+919714012746'        # YOUR PHONE NUMBER, INCLUDING COUNTRY CODE
...
def add_users_to_group():
    ...
    print('\n\nSelect your Channel:\t' + groups[int(g_index)].title)
...
def list_users_in_group():
    ...
    print('\n\nSelect a Channel:\t' + groups[int(g_index)].title)
